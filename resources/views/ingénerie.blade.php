		...
		<div class="container size-h-3 p-tb-30 flex-col-c-c">
			...
			<div class="flex-wr-c-c">
				<a href="{{route('accueil')}}" class="breadcrumb-item">
					{{ __('ing.breadcrumbitem1') }}
				</a>

				<a href="{{route('services')}}" class="breadcrumb-item">
					{{ __('ing.breadcrumbitem2') }}
				</a>

				<span class="breadcrumb-item">
					{{ __('ing.breadcrumbitem3') }}
				</span>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-40">
					<div class="row p-r-35 p-r-0-sr991">
						<div class="col-12 p-b-25">
							<div>
								<img class="max-s-full m-b-30" src="{{asset('images/services-detail-10.jpg')}}" alt="IMG">
				...
				<div class="col-md-4 col-lg-3 p-b-40">
					...
					<div class="p-b-60">
						<ul class="p-b-30">
							...
							<li class="m-b-5">
								<a href="{{route('services.ingénerie')}}" class="flex-wr-s-c size-a-20 bg-12 t1-m-1 cl-3 hov-3 p-l-20 trans-02 active-1">
				...
				<div class="col-md-12 col-lg-12 p-b-40">
						<div class="row p-r-35 p-r-0-sr991">
							...
							<div class="col-sm-6 col-lg-9 p-b-25">
								<div>
									<img class="max-s-full m-b-30" src="{{asset('images/services-detail-11.jpg')}}" alt="IMG">
