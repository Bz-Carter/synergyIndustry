        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                    <form id="basic-form" action="{{ route('service.store') }}" method="post" enctype="multipart/form-data" novalidate>
                            {{ csrf_field() }}
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="English">
                                    <p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="extrait" rows="5" cols="30" required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>About</label>
                                ...
                                <div class="tab-pane" id="Français">
                                    <p>
                                        ...
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" name="extraitfr" rows="5" cols="30" required></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>A propos</label>
                                            <textarea id="detailb" name="detailb" rows="5" cols="30" required></textarea>
                                        </div>
                                    </p>
                                </div>
                            </div>
