                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="English">
                                    <p>
                                        ...
                                        <div class="form-group">
                                            <label>Info</label>
                                            <input type="text" name="info" value="{{ $slide->info }}" class="form-control" required>
                                        </div>
                                    </p>
                                </div>
                                <div class="tab-pane" id="Français">
                                    <p>
                                        <div class="form-group">
                                            <label>Titre</label>
                                            <input type="text" name="titlefr" value="{{ $slide->titlefr }}" class="form-control" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Info</label>
                                            <input type="text" name="infofr" value="{{ $slide->infofr }}" class="form-control" required>
                                        </div>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-lg-3 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="number" name="delay" value="{{ $slide->delay }}" class="form-control time24" min="1" max="10">
                                    </div>
                                </div>
                                <label>Photo</label>
