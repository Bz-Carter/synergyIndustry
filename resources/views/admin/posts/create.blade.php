        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                    <form id="basic-form" action="{{ route('post.store') }}" method="post" enctype="multipart/form-data" novalidate>
                            {{ csrf_field() }}
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="English">
                                    <p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="summernote" name="description" rows="5" cols="5" required></textarea>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>Content</label>
                                            <textarea class="summernote" name="content" rows="5" cols="30" required></textarea>
                                        </div>
                                    </p>
                                </div>
                                <div class="tab-pane" id="Français">
                                    <p>
                                        ...
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="summernote" name="descriptionfr" rows="5" cols="5" required></textarea>
                                        </div>
                                        <br>
                                        <div class="form-group">
                                            <label>Contenu</label>
                                            <textarea class="summernote" name="contentfr" rows="5" cols="30" required></textarea>
                                        </div>
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach ($tags as $tag)
                                                ...
                                                <input type="checkbox" name="tags[]" value="{{ $tag->id }}" required data-parsley-errors-container="#error-checkbox">
                                                    <span>{{ $tag->tag }}</span>
                                                </label>
                                            @endforeach
