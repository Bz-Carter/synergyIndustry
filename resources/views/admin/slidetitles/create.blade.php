    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    <div class="header">
                        <h2>New Slidetitle</h2>
                    </div>

                    @include('admin.includes.errors')

                    <div class="body">
                    <form id="basic-form" action="{{ route('slidetitle.store') }}" method="post" novalidate>
                            {{ csrf_field() }}
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-success">Store Slidetitle</button>
                            </div>
                        </form>
                    </div>
                </div>
